 ...
 */
public class AlertxDialog extends BaseDialog {

	private TextView mIvTipIcon;
	 ...
	 * @param context
	 */
	public AlertxDialog(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 * @param theme
	 */
	public AlertxDialog(Context context, int theme) {
		super(context, theme);
		initView(context);
	}
	 ...
	 */
	public AlertxDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
	...
	private void initView(Context context) {
		mView = View.inflate(context, R.layout.dialog_alert, null);

		mIvTipIcon = (TextView) mView.findViewById(R.id.dialog_iv_tip);
