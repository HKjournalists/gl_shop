...
public class AddrListAdapter extends BasicAdapter<AddrInfoModel> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (StringUtils.isNEmpty(model.areaName) && StringUtils.isNEmpty(model.deliveryAddrDetail)) {
			mTvAddrContent.setText(mContext.getString(R.string.data_empty));
		} else {
			mTvAddrContent.setText(model.areaName + model.deliveryAddrDetail);
		}
