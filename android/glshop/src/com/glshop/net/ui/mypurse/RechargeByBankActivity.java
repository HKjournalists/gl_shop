...
public class RechargeByBankActivity extends BasicActivity {
	...
	private void initView() {
		...
		((TextView) getView(R.id.tv_custom_service_phone)).setText(GlobalConstants.Common.PLATFORM_CUSTOM_SERVICE_PHONE);
		((TextView) getView(R.id.tv_pay_money_tips)).setText(getString(R.string.recharge_bank_info, StringUtils.getCashNumber(String.valueOf(needPayMoney))));
	}
