...
public class FindPwdActivity extends BasicActivity {
	...
	private void initView() {
		...
		((TextView) getView(R.id.tv_find_pwd_tips)).setText(getString(R.string.find_pwd_security_tips, GlobalConstants.Common.PLATFORM_CUSTOM_SERVICE_PHONE));
	}
	...
	protected void handleStateMessage(Message message) {
		...
		case UserMessageType.MSG_GET_SMS_VERFIYCODE_SUCCESS:
			if (respInfo != null && isCurRequest(mSmsCodeInvoker, String.valueOf(respInfo.invoker))) {
	...
	private void doNextAction() {
		...
		if (StringUtils.isEmpty(account)) {
			...
			mAccount = account;
			ActivityUtil.hideKeyboard(this);
			showSubmitDialog(getString(R.string.geting_img_verifycode_hint));
