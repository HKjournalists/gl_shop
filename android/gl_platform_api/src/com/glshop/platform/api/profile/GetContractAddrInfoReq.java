 ...
 */
public class GetContractAddrInfoReq extends BaseRequest<GetAddrInfoResult> {
	...
	public GetContractAddrInfoReq(Object invoker, IReturnCallback<GetAddrInfoResult> callBackx) {
