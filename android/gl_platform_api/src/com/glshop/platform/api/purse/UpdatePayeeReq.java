 ...
 */
public class UpdatePayeeReq extends BaseRequest<CommonResult> {
	...
	public UpdatePayeeReq(Object invoker, IReturnCallback<CommonResult> callBackx) {
