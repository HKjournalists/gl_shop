 ...
 */
public class CancelContractReq extends BaseRequest<CommonResult> {
	...
	public CancelContractReq(Object invoker, IReturnCallback<CommonResult> callBackx) {
	...
	protected String getTypeURL() {
		return "/contract/singleCancelContract";
	}
