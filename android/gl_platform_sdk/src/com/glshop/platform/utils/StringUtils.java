...
public final class StringUtils {
	...
	public static String object2string(Object object) {
		...
		if ((object instanceof String) || (object instanceof Number) || (object instanceof Map) || (object instanceof Collection)) {
			sb.append(object);
		} else {
			...
			try {
				for (Field field : fieldList) {
					...
					sb.append(ReflectUtil.getFieldValue(object, field.getName())).append(',');
				}
				if (sb.length() > 0) {
					sb.deleteCharAt(sb.length() - 1);
				}
			} catch (Exception e) {
				Logger.e(TAG, "object2string error.", e);
			}
	 ...
	 * @return
	 */
	public static String getPercent(float num) {
