...
public class CompanyInfoEditActivity extends BasicActivity {
	...
	private void initView() {
		...
		titleView = getView(R.id.et_titleType);
	...
	private void initData() {
		...
		String typename = getIntent().getStringExtra(GlobalAction.ProfileAction.EXTRA_KEY_COMPANY_TYPE_INFO);
		if(TextUtils.isEmpty(typename)){
			typename = getString(R.string.company_info_mgr);
		}
		((TextView) getView(R.id.tv_commmon_title)).setText(typename);
		titleView.setText(typename);
		...
		if (info != null) {
			...
			requestSelection(mEtIntroDetail);
