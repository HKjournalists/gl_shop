...
public interface GlobalAction {
	...
	public interface MessageAction {
		 ...
		 * 消息状态编辑还是不可编辑
		 */
		public static final String EXTRA_KEY_MESSAGE_EDITOR="extra_key_message_editor";

		/**
		 * 消息全选
		 */
		public static final String EXTRA_KEY_MESSAGE_SELECT_ALL="extra_key_message_selectall";

        /**
         * 消息全不选
         */
        public static final String EXTRA_KEY_MESSAGE_SELECT_NOT="extra_key_message_select_not";

		/**
		 * 消息信息列表
		 */
		public static final String EXTRA_KEY_MESSAGE_LIST = "extra_key_message_list";


		/**
		 * 消息选中可操作数据
		 */
		public static final String EXTRA_KEY_MESSAGE_SELECT_EDITOR="extra_key_message_select_ditor";

		/**
		 * 消息empty
		 */
		public static final String EXTRA_KEY_MESSAGE_EMPYT="extra_key_message_empyt";
