...
import com.glshop.net.ui.basic.adapter.contract.OngoingContractListAdapter;
 ...
 */
public class OngoingContractListFragment extends BaseContractListFragment<ContractSummaryInfoModel> {

	public OngoingContractListFragment() {

	}

	@Override
	protected BasicAdapter<ContractSummaryInfoModel> getAdapter() {
		mAdapter = new OngoingContractListAdapter(mContext, mInitData);
		return mAdapter;
	}
