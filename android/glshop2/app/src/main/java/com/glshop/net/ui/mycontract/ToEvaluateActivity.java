...
public class ToEvaluateActivity extends BaseContractInfoActivity {
	...
	private void initView() {
		...
		mSincerityPerBar = getView(R.id.rb_sincerity_per);
	}
	...
	private void initData() {
		if (mContractInfo != null) {
			...
			int limitDay = SysCfgUtils.getEvaLimitDay(this);
			((TextView) getView(R.id.tv_eva_limit_tips)).setText(getString(R.string.contract_evaluation_time_tips, limitDay));
		} else {
			showToast("合同信息不能为空!");
			finish();
		}
