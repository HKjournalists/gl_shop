...
public final class DataCenter {
	...
	/** 消息列表 系统*/
	private List<MessageInfoModel> mMessageSystemList = new ArrayList<MessageInfoModel>();

	/** 消息列表 活动*/
	private List<MessageInfoModel> mMessageActivityList = new ArrayList<MessageInfoModel>();

	/** 消息列表 资讯*/
	private List<MessageInfoModel> mMessageInfoList = new ArrayList<MessageInfoModel>();

	/** 消息列表 交易*/
	private List<MessageInfoModel> mMessageTransactionList = new ArrayList<MessageInfoModel>();
	...
	public interface DataType {
		...
		/** 消息列表 */
		public static final int MESSAGE_ALL_LIST = 11;
		...
		/** 消息列表-系统消息 */
		public static final int MESSAGE_SYSTEM_LIST = 16;

		/** 消息列表-交易消息*/
		public static final int MESSAGE_INFO_LIST = 17;

		/** 消息列表-资讯消息*/
		public static final int MESSAGE_TRANSACTION_LIST = 18;

		/** 消息列表-活动消息*/
		public static final int MESSAGE_ACTIVITY_LIST = 19;
	...
	private DataCenter() {
		...
		mDataMap.put(DataType.MESSAGE_ALL_LIST, mMessageList);
		mDataMap.put(DataType.MESSAGE_SYSTEM_LIST, mMessageSystemList);
		mDataMap.put(DataType.MESSAGE_ACTIVITY_LIST, mMessageActivityList);
		mDataMap.put(DataType.MESSAGE_TRANSACTION_LIST, mMessageTransactionList);
		mDataMap.put(DataType.MESSAGE_INFO_LIST, mMessageInfoList);
	...
	private boolean isCoverData(int dataType, DataReqType reqType) {
		...
		if (reqType == DataReqType.REFRESH) {
			...
			if (dataType == DataType.FINDBUY_BUYER_LIST || dataType == DataType.FINDBUY_SELLER_LIST || dataType == DataType.MY_BUY_LIST || dataType == DataType.UFM_CONTRACT_LIST
					|| dataType == DataType.ONGOING_CONTRACT_LIST || dataType == DataType.ENDED_CONTRACT_LIST || dataType == DataType.MESSAGE_ALL_LIST|| dataType == DataType.MESSAGE_SYSTEM_LIST|| dataType == DataType.MESSAGE_ACTIVITY_LIST|| dataType == DataType.MESSAGE_INFO_LIST|| dataType == DataType.MESSAGE_TRANSACTION_LIST) {
				isCoverModel = true;
			}
		}
		return isCoverModel;
