...
public interface IMessageLogic extends ILogic {
	 ...
	 * @param companyId
	 */
	void getMessageListFromServer(String companyId, DataConstants.SystemMsgType type,int pageIndex, int pageSize, DataReqType reqType);
	 ...
	 * @param ids
	 */
	void delMessage(List<MessageInfoModel> ids);
