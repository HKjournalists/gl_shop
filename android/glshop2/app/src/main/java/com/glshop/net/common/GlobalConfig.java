...
public class GlobalConfig {
     ...
     * 设置新安装的APP的版本号
     */
    public void setAPPVersionCode(int newCode) {
        setSPValue(GlobalConstants.SPKey.VERSION_CODE, newCode);
    }
    /***
     * 获取旧版本的APP版本号
     */
    public int getAPPVersionCode() {
       return getIntegerSPValue(GlobalConstants.SPKey.VERSION_CODE);
    }
    /***
     * 设置是否显示引导页
     */
    public void setFirstStarAPP(boolean showbootpage) {
        setSPValue(GlobalConstants.SPKey.BOOT_PAGE, showbootpage);
    }

    /***
     * 是否显示引导页
     */
    public boolean getFirstStarAPP() {
        return getBooleanSPValue(GlobalConstants.SPKey.BOOT_PAGE,true);
    }
     ...
     * @return
     */
    public static Boolean getBooleanSPValue(String key,boolean defaultvalue) {
        return PlatformConfig.getBoolean(key,defaultvalue);
    }
    /**
     * 获取SP值
     *
     ...
     * @return
     */
    public static Integer getIntegerSPValue(String key) {
        return PlatformConfig.getInt(key);
    }
    /**
     * 获取SP值
     *
