...
public class RechargeByBankActivity extends BasicActivity {
	...
	private void initView() {
		...
		String highlightTips = StringUtils.getCashNumber(needPayMoney);
		String tips = getString(R.string.recharge_bank_info, highlightTips);
		((TextView) getView(R.id.tv_security_tips)).setText(StringUtils.getHighlightText(tips, highlightTips, getResources().getColor(R.color.red)));
	}
