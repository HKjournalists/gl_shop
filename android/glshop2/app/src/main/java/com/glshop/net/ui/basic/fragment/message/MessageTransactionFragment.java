 ...
 * @author : veidy
 * @version : 1.0
 * @Description : 消息列表-交易类型
 * @Copyright : GL. All Rights Reserved
 * @Company : 江苏国立网络科技有限公司
 * @Create Date  : 2015/9/21  17:15
 */
public class MessageTransactionFragment extends BaseMessageListFragment {
    ...
    protected DataConstants.SystemMsgType getSysMsgType() {
        return DataConstants.SystemMsgType.TRANSACTION;
    }
