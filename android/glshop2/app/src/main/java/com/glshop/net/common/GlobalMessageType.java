...
public interface GlobalMessageType {
	...
	public interface MsgCenterMessageType {
		...
		/** 删除消息*/
		int MSG_DEL_MSG_NUM = BASE + 12;

		/** 设置为已读*/
		int MSG_REFRESH_MSG_NUM = BASE + 13;

		/** 选中要操作的消息*/
		int MSG_SELECT_MSG_NUM = BASE + 14;

		/** 删除消息成功*/
		int MSG_DEL_MSG_SUCCESS = BASE + 15;

		/** 删除消息失败*/
		int MSG_DEL_MSG_FAILED = BASE + 16;
	}
	...
	public interface Advertising{
		...
		/** 预约团购活动 */
		int JOIN_GROUPBUY_SUCCESS = BASE + 1;

		int JOIN_GROUPBUY_FAILED = BASE +2;

		/**首页广告图获取成功*/
		int BANNER_SUCCESS = BASE +3;

		/**首页广告图获取失败*/
		int BANNER_FAILED = BASE +4;
	}
}
