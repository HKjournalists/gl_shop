...
public interface IBuyLogic extends ILogic {
	 ...
	 * 获取求购/供应信息列表(包括筛选/排序)
	 */
	public void getBuys(BuyFilterInfoModelV2 filterInfo, boolean isFilterMode, BuyType type, int pageIndex, int pageSize, DataReqType reqType);
	...
	/**
	 * 重新发布（此接口暂未实现，目前重新发布接口调用的是pubBuyInfo发布接口）
	 * @param buyId
	 */
	@Deprecated
