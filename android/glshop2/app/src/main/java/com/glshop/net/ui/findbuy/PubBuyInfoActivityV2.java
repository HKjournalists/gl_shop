...
public class PubBuyInfoActivityV2 extends BasicFragmentActivity implements Callback {
	...
	private void showExitDialog() {
		closeDialog(mExitDialog);
		mExitDialog = new ConfirmDialog(this, R.style.dialog);
		mExitDialog.setContent(getString(R.string.exit_pub_warning_tips));
		mExitDialog.setCallback(new IDialogCallback() {
