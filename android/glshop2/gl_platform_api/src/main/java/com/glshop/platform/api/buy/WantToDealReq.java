 ...
 */
public class WantToDealReq extends BaseRequest<CommonResult> {
	...
	public WantToDealReq(Object invoker, IReturnCallback<CommonResult> callBackx) {
