 ...
 */
public class DeletePubBuyInfoReq extends BaseRequest<CommonResult> {
	...
	public DeletePubBuyInfoReq(Object invoker, IReturnCallback<CommonResult> callBackx) {
