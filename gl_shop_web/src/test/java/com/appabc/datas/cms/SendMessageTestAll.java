...
@Transactional
public class SendMessageTestAll {
	...
	public static void sendIncludeImageEmail(){
		MailMessageSender mms = new MailMessageSender(SendMailType.HTML);
	...
	public static void sendIncludeAttachmentFileEmail(){
		MailMessageSender mms = new MailMessageSender(SendMailType.HTML);
	...
	public static void sendIncludeAllEmail(){
		MailMessageSender mms = new MailMessageSender(SendMailType.HTML);
		mms.setTo("276261562@qq.com");
