...
import com.appabc.datas.system.GroupPermission;
import com.appabc.system.web.AbstractListBaseController;
import com.appabc.system.web.security.UserPermissionAuthority;
...
public class FinanceController extends AbstractListBaseController {
    ...
    protected void clearModel(ModelMap model) {
        model.clear();
    }
