...
public class UserPermissionDao extends AbstractBaseSystemDao<UserPermission> implements RowMapper<UserPermission> {
    ...
    /* (non-Javadoc)
         * @see AbstractBaseSystemDao#create(java.lang.Object)
         */
	@Override
	...
	/* (non-Javadoc)
	 * @see AbstractBaseSystemDao#update(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see AbstractBaseSystemDao#delete(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see AbstractBaseSystemDao#queryForList(java.util.Map, int, int, java.lang.String[])
	 */
	@Override
