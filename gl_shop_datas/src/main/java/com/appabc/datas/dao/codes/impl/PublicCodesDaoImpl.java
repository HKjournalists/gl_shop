...
public class PublicCodesDaoImpl extends BaseJdbcDao<TPublicCodes> implements IPublicCodesDao{
	...
	private static final String INSERTSQL = " insert into T_PUBLIC_CODES (CODE, VAL, NAME, PCODE,ORDERNO) values (:code, :val, :name, :pcode,:orderno) ";
	private static final String UPDATESQL = " update T_PUBLIC_CODES set CODE = :code, VAL = :val, NAME = :name, PCODE = :pcode,ORDERNO=:orderno where ID = :id ";
