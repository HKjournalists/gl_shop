...
public class ContractMatchTrigger extends BaseCronTrigger {
	...
	public ContractMatchTrigger() throws ParseException{
		super();
		this.setName(NAME);
		this.setGroup(GROUP);
	...
	public ContractMatchTrigger(String jobName,String jobGroup,String cronExpression) throws ParseException{
		this();
	...
	public ContractMatchTrigger(String name,String group,String jobName,String jobGroup,String cronExpression) throws ParseException{
