...
typedef NS_ENUM(NSInteger, WLSegmentSelectedStyle) {
    WLSegmentSelectedStyleFill,
    WLSegmentSelectedStyleFillText,
    WLSegmentSelectedStyleSketch,
};
...
@property (nonatomic, assign) WLSegmentSelectedStyle selectedStyle;
