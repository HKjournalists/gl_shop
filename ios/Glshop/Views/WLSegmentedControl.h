...
typedef NS_ENUM(NSInteger, WLVLSegmentSelectedStyle) {
    WLVLSegmentSelectedStyleFill,
    WLVLSegmentSelectedStyleFillText,
    WLVLSegmentSelectedStyleSketch,
};

typedef void(^SelectSegment)(NSInteger index);

@interface WLSegmentedControl : UIControl {
	NSMutableArray *_segments;
}

@property (nonatomic, assign) WLVLSegmentSelectedStyle selectedStyle;
...
@property (nonatomic, copy) SelectSegment selcetBlock;
