...
- (void)setSelectedStyle:(WLVLSegmentSelectedStyle)selectedStyle {
    _selectedStyle = selectedStyle;
    NSInteger style = selectedStyle;
    for (WLSegment *segment in _segments) {
        segment.selectedStyle = style;
    }
}
...
//	UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:CGRectInset(self.bounds, lineWidth / 2, lineWidth / 2) byRoundingCorners:UIRectCornerAllCorners cornerRadii:CGSizeMake(3.5f, 3.5f)];
    ...
    UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:CGRectInset(self.bounds, lineWidth / 2, lineWidth / 2) byRoundingCorners:UIRectCornerAllCorners cornerRadii:CGSizeMake(0, 0)];
