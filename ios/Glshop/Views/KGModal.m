...
- (void)hideAnimated:(BOOL)animated{
    ...
    //--------------------add--------------
    if ([self.delegate respondsToSelector:@selector(flipViewWillHide)]) {
        [self.delegate flipViewWillHide];
    }
...
//    self.window.top = SCREEN_HEIGHT;// MyWarning
