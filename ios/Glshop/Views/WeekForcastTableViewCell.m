...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _productNameLabel.font = [UIFont systemFontOfSize:FONT_13];
        _productNameLabel.textColor = ColorWithHex(@"#646464");
        [self.contentView addSubview:_productNameLabel];
        
        _sizeLabel = [UILabel labelWithTitle:@"(1.1-1.8)"];
        _sizeLabel.frame = CGRectMake(8, _productNameLabel.vbottom-3, _productNameLabel.vwidth, 20);
        _sizeLabel.textColor = ColorWithHex(@"#646464");
        ...
        _todayPriceLabel.font = [UIFont systemFontOfSize:FONT_13];
        _todayPriceLabel.textAlignment = NSTextAlignmentCenter;
        _todayPriceLabel.textColor = ColorWithHex(@"#333333");
        ...
        _oneWeekLabel.font = [UIFont systemFontOfSize:FONT_13];
        ...
        _twoWeekLabel.font = [UIFont systemFontOfSize:FONT_13];
...
- (void)setWeekModel:(ProductWeekModel *)weekModel {
    ...
    NSString *image1Name = oneFloat > 1 ? @"index_icon_arrow_on_hongse" : @"index_icon_arrow-down" ;
    _indicteOne.image = [UIImage imageNamed:image1Name];
    
    NSString *image2Name = twoFloat > 1 ? @"index_icon_arrow_on_hongse" :@"index_icon_arrow-down";
