...
@property (nonatomic, assign) CGFloat vtop;
@property (nonatomic, assign) CGFloat vleft;
@property (nonatomic, assign) CGFloat vbottom;
@property (nonatomic, assign) CGFloat vright;
