...
{
    CGRect frame = self.frame;
    frame.origin.x = vleft;
    self.frame = frame;
}

- (CGFloat)vright
{
    return self.vleft + self.vwidth;
}

- (void)setVright:(CGFloat)vright
{
    CGRect frame = self.frame;
    frame.origin.x = vright - frame.size.width;
    self.frame = frame;
}

- (CGFloat)vbottom
{
    return self.vtop + self.vheight;
}

- (void)setVbottom:(CGFloat)vbottom
{
    CGRect frame = self.frame;
    frame.origin.y = vbottom - frame.size.height;
    self.frame = frame;
}
