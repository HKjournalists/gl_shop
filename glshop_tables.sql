...
Source Host           : 121.41.20.176:3306
...
Date: 2014-12-23 16:23:54
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for SYS_FINANCE_REMITS
-- ----------------------------
DROP TABLE IF EXISTS `SYS_FINANCE_REMITS`;
CREATE TABLE `SYS_FINANCE_REMITS` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `AMOUNT` float(12,2) NOT NULL COMMENT '收到汇款金额',
  `REMITTER_ACCOUNT` varchar(30) DEFAULT NULL COMMENT '汇款人银行帐号',
  `RECEIVE_TIME` datetime DEFAULT NULL COMMENT '收到款项时间',
  `BANK_SERIAL_NUMBER` varchar(20) DEFAULT NULL COMMENT '银行汇款流水号',
  `MOBILE` varchar(20) DEFAULT NULL COMMENT '收款人手机号码',
  `REMITTER` varchar(10) DEFAULT NULL COMMENT '汇款人',
  `CONTRACT_ID` varchar(50) DEFAULT NULL COMMENT '合同编号',
  `COMPANY` varchar(50) DEFAULT NULL COMMENT '公司名称',
  `CREATOR` int(11) NOT NULL COMMENT '汇款录入者',
  `PROCESSOR` int(11) DEFAULT NULL COMMENT '汇款处理者',
  `AUDITOR` int(11) DEFAULT NULL COMMENT '汇款审核者',
  `STATUS` int(11) DEFAULT NULL COMMENT '0: 待处理, 1: 待审核, 2: 审核通过, 3: 无法处理',
  `TARGET_COMPANY_ID` varchar(20) DEFAULT NULL COMMENT '实际汇款对象ID',
  `TARGET_WALLET_TYPE` char(1) DEFAULT NULL COMMENT '钱包类型，参见T_OFFLINE_PAY',
  `REMARK` varchar(200) DEFAULT NULL COMMENT '其他信息',
  ...
  KEY `AUDITOR` (`AUDITOR`),
  CONSTRAINT `SYS_FINANCE_REMITS_ibfk_1` FOREIGN KEY (`CREATOR`) REFERENCES `SYS_USERS` (`ID`),
  CONSTRAINT `SYS_FINANCE_REMITS_ibfk_2` FOREIGN KEY (`PROCESSOR`) REFERENCES `SYS_USERS` (`ID`),
  CONSTRAINT `SYS_FINANCE_REMITS_ibfk_3` FOREIGN KEY (`AUDITOR`) REFERENCES `SYS_USERS` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='汇款录入记录';
...
CREATE TABLE `SYS_TASKS` (
  ...
  `OWNER` int(11) DEFAULT NULL COMMENT '任务执行人',
  ...
  KEY `CID` (`CID`),
  KEY `OWNER` (`OWNER`),
  CONSTRAINT `SYS_TASKS_ibfk_1` FOREIGN KEY (`CID`) REFERENCES `T_COMPANY_INFO` (`ID`),
  CONSTRAINT `SYS_TASKS_ibfk_2` FOREIGN KEY (`OWNER`) REFERENCES `SYS_USERS` (`ID`)
...
CREATE TABLE `SYS_USER_PERMISSIONS` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ix_user_permission` (`USER_ID`,`PERMISSION`),
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='管理系统帐号';
...
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 COMMENT='企业认证记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='企业卸货地址';
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='企业认证信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='企业联系人';
...
) ENGINE=InnoDB AUTO_INCREMENT=167 DEFAULT CHARSET=utf8 COMMENT='企业评价表';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='个人认证信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='企业统计信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='企业船舶信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8 COMMENT='订单的收货地址';
...
CREATE TABLE `T_ORDER_FIND` (
  ...
  `MOREAREA` char(1) DEFAULT NULL COMMENT '是否发布多个地区（卖家的需求）1单，2多',
...
) ENGINE=InnoDB AUTO_INCREMENT=83 DEFAULT CHARSET=utf8 COMMENT='感兴趣、客服电话沟通列表';
...
) ENGINE=InnoDB AUTO_INCREMENT=160 DEFAULT CHARSET=utf8 COMMENT='交易中的商品详细';
...
CREATE TABLE `T_ORDER_PRODUCT_PROPERTY` (
  ...
  `PPROID` varchar(50) DEFAULT NULL COMMENT '父商品属性ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=713 DEFAULT CHARSET=utf8 COMMENT='交易中的商品的属性';
...
) ENGINE=InnoDB AUTO_INCREMENT=280 DEFAULT CHARSET=utf8 COMMENT='商品价格明细(当天)';
...
) ENGINE=InnoDB AUTO_INCREMENT=262 DEFAULT CHARSET=utf8 COMMENT='商品价格预测';
...
CREATE TABLE `T_PUSH_RESULT` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=1079 DEFAULT CHARSET=utf8 COMMENT='消息推送结果';
...
CREATE TABLE `T_SCHEDULE_INFO` (
  ...
  `CREATEDATE` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`SCHID`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8 COMMENT='定时任务调度信息';
...
CREATE TABLE `T_SHORT_MESSAGE_USED` (
  ...
  `REMARK` varchar(250) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`SMUID`)
) ENGINE=InnoDB AUTO_INCREMENT=730 DEFAULT CHARSET=utf8 COMMENT='T_SHORT_MESSAGE_USED\r\n短信接口使用记录';
...
CREATE TABLE `T_SYSTEM_MESSAGE` (
  ...
  PRIMARY KEY (`MSGID`)
) ENGINE=InnoDB AUTO_INCREMENT=1201 DEFAULT CHARSET=utf8 COMMENT='系统消息';
...
CREATE TABLE `T_SYSTEM_PARAMS` (
  ...
  `UPDATETIME` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`SID`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='系统参数';
...
CREATE TABLE `T_UPLOAD_IMAGES` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=3559 DEFAULT CHARSET=utf8 COMMENT='图片上传管理表';
...
) ENGINE=InnoDB AUTO_INCREMENT=191 DEFAULT CHARSET=utf8 COMMENT='用户通行证';
